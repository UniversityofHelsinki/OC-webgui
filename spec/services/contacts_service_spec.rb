RSpec.describe ContactsService, type: :service do
  ...
  context "When searching for stats by agent" do
    ...
    it "Returns correct queue durations by times" do
      expect(@contacts_service.queue_durations_by_times).to eq([['2016-07-18 05:00:00.000000000 +0000', 60.0], ['2016-07-18 08:00:00.000000000 +0000', 240.0], ['2016-07-18 09:00:00.000000000 +0000', 120.0]])
    end
  end
end
